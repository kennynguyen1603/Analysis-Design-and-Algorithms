...
{
private:
    vector<pair<int, int>> cities; // Lưu trữ tọa độ của các thành phố
...
public:
    // Constructor: khởi tạo với danh sách các thành phố
    TravelingSalesman(const vector<pair<int, int>> &cities) : cities(cities) {}
...
private:
    // Hàm đệ quy cho phương thức Brute Force
